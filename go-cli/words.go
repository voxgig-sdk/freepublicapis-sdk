...
func registerSDKWords(r *eng.Registry, client *sdk.FreepublicapisSDK) {
...
func runOp(client *sdk.FreepublicapisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
