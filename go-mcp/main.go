// Command Freepublicapis-mcp is an MCP server exposing the Freepublicapis
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Freepublicapis_list  — list records of an entity
//	Freepublicapis_load  — load a single record of an entity
//
