...
func registerTools(server *mcp.Server, client *sdk.FreepublicapisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "freepublicapis_list",
		Description: "List records from Freepublicapis. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "freepublicapis_load",
		Description: "Load a single record from Freepublicapis. " +
...
func runOp(client *sdk.FreepublicapisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreepublicapisSDK, name string) (sdk.FreepublicapisEntity, error) {
