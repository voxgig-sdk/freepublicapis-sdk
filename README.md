...
This is an unofficial SDK for the Free Public APIs public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/freepublicapis` | `npm install @voxgig-sdk/freepublicapis` |
| Python | `voxgig-sdk-freepublicapis` | `pip install voxgig-sdk-freepublicapis` |
| PHP | `voxgig-sdk/freepublicapis` | `composer require voxgig-sdk/freepublicapis` |
| Golang | `github.com/voxgig-sdk/freepublicapis-sdk/go` | `go get github.com/voxgig-sdk/freepublicapis-sdk/go` |
| Ruby | `voxgig-sdk-freepublicapis` | `gem install voxgig-sdk-freepublicapis` |
| Lua | `voxgig-sdk-freepublicapis` | `luarocks install voxgig-sdk-freepublicapis` |
