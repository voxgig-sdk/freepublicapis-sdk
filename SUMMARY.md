...
Results: Successful response with list of APIs; Successful response with a random API; Successful response with API details.
...
| --- | --- | --- | --- |
| Api | `list` | `GET /api/apis` | See reference |
| Api | `list` | `GET /api/random` | See reference |
| Api | `load` | `GET /api/apis/{id}` | See reference |

## Connect to the API

- Production server: `https://www.freepublicapis.com`
...
- `freepublicapis_list`: List records for an entity. Supported entities: `api`.
- `freepublicapis_load`: Load one record for an entity. Supported entities: `api`.
