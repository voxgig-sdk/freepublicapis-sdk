...
// Freepublicapis SDK cache feature
...
class FreepublicapisCacheFeature extends FreepublicapisBaseFeature
{
    ...
    private function _through(FreepublicapisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
