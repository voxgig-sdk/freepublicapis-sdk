...
// Freepublicapis SDK timeout feature
...
class FreepublicapisTimeoutFeature extends FreepublicapisBaseFeature
{
    ...
    private function _with_timeout(FreepublicapisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreepublicapisContext $_ctx, float $ms): void
    {
        $client = $this->client;
