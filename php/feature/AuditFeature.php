...
// Freepublicapis SDK audit feature
...
class FreepublicapisAuditFeature extends FreepublicapisBaseFeature
{
    ...
    private function _emit(FreepublicapisContext $ctx, string $outcome): void
    {
