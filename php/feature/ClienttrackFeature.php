...
// Freepublicapis SDK clienttrack feature
...
class FreepublicapisClienttrackFeature extends FreepublicapisBaseFeature
{
    ...
    public function PostConstruct(FreepublicapisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Freepublicapis-SDK';
