...
// Freepublicapis SDK paging feature
...
class FreepublicapisPagingFeature extends FreepublicapisBaseFeature
{
    ...
    private function _is_list(FreepublicapisContext $ctx): bool
    {
