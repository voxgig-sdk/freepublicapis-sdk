...
// Freepublicapis SDK debug feature
...
class FreepublicapisDebugFeature extends FreepublicapisBaseFeature
{
    ...
    private function _finish(FreepublicapisContext $ctx, bool $ok): void
    {
