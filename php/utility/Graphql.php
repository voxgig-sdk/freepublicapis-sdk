...
// Freepublicapis SDK utility: graphql
//
...
class FreepublicapisGraphql
{
    ...
    // equivalent.
    public static function body(FreepublicapisContext $ctx): mixed
    {
    ...
    public static function errors(FreepublicapisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
