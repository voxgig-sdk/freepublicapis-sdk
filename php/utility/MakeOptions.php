...
// Freepublicapis SDK utility: make_options

class FreepublicapisMakeOptions
{
    ...
    public static function call(FreepublicapisContext $ctx): array
    {
        ...
        //
        // `FreepublicapisSchema::optspec()` is built from the model:
        ...
        $optspec = FreepublicapisSchema::optspec();
