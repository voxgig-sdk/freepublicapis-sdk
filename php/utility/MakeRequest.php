...
// Freepublicapis SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreepublicapisMakeRequest
{
    public static function call(FreepublicapisContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreepublicapisResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreepublicapisResponse($fetched);
        } else {
