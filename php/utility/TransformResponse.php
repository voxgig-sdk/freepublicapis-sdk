...
// Freepublicapis SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreepublicapisTransformResponse
{
    public static function call(FreepublicapisContext $ctx): mixed
    {
        ...
        $transform = FreepublicapisHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
