...
// Freepublicapis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreepublicapisSDK::test)
...
{
    private const SDK_CLASS = 'FreepublicapisSDK';
    ...
    private const SDK_BASE = 'freepublicapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freepublicapis_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
