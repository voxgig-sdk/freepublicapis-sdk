# Freepublicapis Golang SDK Reference

Complete API reference for the Freepublicapis Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreepublicapisSDK`
