...
The Python SDK for the Freepublicapis API. Provides an entity-oriented interface following Pythonic conventions.
...
client = FreepublicapisSDK({
    "apikey": os.environ.get("FREEPUBLICAPIS_APIKEY"),
})
```
...
result, err = client.Freepublicapis(None).load(
    {"id": "test01"}, None
)
