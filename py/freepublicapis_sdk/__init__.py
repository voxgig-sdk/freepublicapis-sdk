...
from freepublicapis_sdk.utility import register

# Load features
from freepublicapis_sdk.feature.base_feature import FreepublicapisBaseFeature
from freepublicapis_sdk.features import _has_feature, _make_feature
...
class FreepublicapisSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreepublicapisUtility()
        self._utility = utility

        from freepublicapis_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreepublicapisUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreepublicapisSDK: graphql: " + str(msg))
            res["graphql"] = errors
