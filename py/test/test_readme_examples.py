# Freepublicapis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreepublicapisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreepublicapisSDK(...) and FreepublicapisSDK.test(...) become
#      FreepublicapisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freepublicapis_sdk"
_SDK_CLASS = "FreepublicapisSDK"
