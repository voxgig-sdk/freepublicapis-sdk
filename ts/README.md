# Freepublicapis TypeScript SDK

The TypeScript SDK for the Freepublicapis API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `FreepublicapisSDK.test(testopts?, sdkopts?)` | `FreepublicapisSDK` | Create a test-mode client. |
...
| `client` | `client(): FreepublicapisSDK` | Return the parent SDK client. |
...
freepublicapis/
├── src/
│   ├── FreepublicapisSDK.ts        # Main SDK class
