...
(0, node_test_1.describe)('ApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreepublicapisSDK({
...
function liveScenariosActive() { return false && process.env.FREEPUBLICAPIS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreepublicapisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREEPUBLICAPIS_TEST_API_ENTID'];
    ...
    const client = new __1.FreepublicapisSDK({
        base: 'http://localhost:8080',
