...
function envOverride(m) {
    if ('TRUE' === process.env.FREEPUBLICAPIS_TEST_LIVE ||
        'TRUE' === process.env.FREEPUBLICAPIS_TEST_OVERRIDE) {
    ...
    m.FREEPUBLICAPIS_TEST_EXPLAIN = process.env.FREEPUBLICAPIS_TEST_EXPLAIN || m.FREEPUBLICAPIS_TEST_EXPLAIN;
    return m;
}
