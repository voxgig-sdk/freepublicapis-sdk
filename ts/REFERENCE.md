# Freepublicapis TypeScript SDK Reference

Complete API reference for the Freepublicapis TypeScript SDK.
...
```ts
new FreepublicapisSDK(options?: object)
```
...
#### `FreepublicapisSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FreepublicapisSDK` instance in test mode.
...
Alias for `FreepublicapisSDK.test()`.
...
Return the parent `FreepublicapisSDK` instance.
