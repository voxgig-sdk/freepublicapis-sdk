...
// Freepublicapis SDK utility: fetcher

class FreepublicapisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreepublicapisSDK/1.0)';
    ...
    public static function call(FreepublicapisContext $ctx, string $fullurl, array $fetchdef): array
    {
