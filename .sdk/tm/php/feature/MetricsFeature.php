...
// Freepublicapis SDK metrics feature
...
class FreepublicapisMetricsFeature extends FreepublicapisBaseFeature
{
    ...
    private function _record(FreepublicapisContext $ctx, bool $ok): void
    {
