...
// Freepublicapis SDK streaming feature
...
class FreepublicapisStreamingFeature extends FreepublicapisBaseFeature
{
    ...
    private function _iterate(FreepublicapisResult $result): \Generator
    {
    ...
    private function _streamable(FreepublicapisContext $ctx): bool
    {
