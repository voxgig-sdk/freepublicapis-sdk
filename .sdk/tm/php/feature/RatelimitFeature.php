...
// Freepublicapis SDK ratelimit feature
...
class FreepublicapisRatelimitFeature extends FreepublicapisBaseFeature
{
    ...
    private function _acquire(FreepublicapisContext $ctx): void
    {
    ...
    private function _track(FreepublicapisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
