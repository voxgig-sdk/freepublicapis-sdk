...
// Freepublicapis SDK idempotency feature
...
class FreepublicapisIdempotencyFeature extends FreepublicapisBaseFeature
{
    ...
    private function _mutating(FreepublicapisContext $ctx): bool
    {
