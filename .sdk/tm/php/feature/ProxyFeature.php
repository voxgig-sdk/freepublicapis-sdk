...
// Freepublicapis SDK proxy feature
...
class FreepublicapisProxyFeature extends FreepublicapisBaseFeature
{
    ...
    public function init(FreepublicapisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreepublicapisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
