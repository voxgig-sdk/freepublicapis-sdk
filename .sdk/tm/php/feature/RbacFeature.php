...
// Freepublicapis SDK rbac feature
...
class FreepublicapisRbacFeature extends FreepublicapisBaseFeature
{
    ...
    private function _required(FreepublicapisContext $ctx): ?string
    {
    ...
    private function _reject(FreepublicapisContext $ctx, string $required): void
    {
    ...
    private function _track(FreepublicapisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
