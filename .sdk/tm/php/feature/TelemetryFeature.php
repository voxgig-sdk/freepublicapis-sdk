...
// Freepublicapis SDK telemetry feature
...
class FreepublicapisTelemetryFeature extends FreepublicapisBaseFeature
{
    ...
    private function _close(FreepublicapisContext $ctx, bool $ok): void
    {
