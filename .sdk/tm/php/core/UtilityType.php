...
// Freepublicapis SDK utility type

class FreepublicapisUtility
{
    ...
    public static function copy(FreepublicapisUtility $src): FreepublicapisUtility
    {
        $u = new FreepublicapisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
