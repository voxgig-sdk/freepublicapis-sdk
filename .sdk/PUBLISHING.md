...
|---|---|---|
| `ts/` | @voxgig-sdk/freepublicapis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/freepublicapis-sdk \
      --repository voxgig-sdk/freepublicapis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/freepublicapis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/freepublicapis-sdk --id=<id>` removes it.
