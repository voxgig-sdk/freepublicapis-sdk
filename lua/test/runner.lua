...
function runner.env_override(m)
  local live = runner.getenv("FREEPUBLICAPIS_TEST_LIVE")
  local override = runner.getenv("FREEPUBLICAPIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEPUBLICAPIS_TEST_EXPLAIN")
